...
namespace Assignment3
{
    public interface ILinkedListADT
    {
        ...
        /// <summary>
        /// Joins multiple linked lists together to create a single linked list.
        /// </summary>
        /// <param name="lists">The linked lists to join.</param>
        /// <returns>A new linked list containing all elements from the provided linked lists.</returns>
        SLL Join(params SLL[] lists);
    }
}
